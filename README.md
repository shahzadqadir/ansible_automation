...
This repository is part of Chapters 7, 8, and 9 of the book Full Stack Network Automation, where we start by writing simple Ansible playbooks to pull information from network devices, then expand them to configure devices and establish end-to-end connectivity. We also learn how to template configurations using Jinja2.
